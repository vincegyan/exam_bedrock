 ...
 */
function bedrock_customize_register( $wp_customize ) {
...
function bedrock_customize_preview_js() {
	wp_enqueue_script( 'bedrock-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
